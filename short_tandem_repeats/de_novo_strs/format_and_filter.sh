...
# concat all files
ls output/monstr/ | grep locus_summary | grep -v chrX | grep -v all | while read l; do cat output/monstr/$l; done > output/monstr/all.locus_summary.tab
ls output/monstr/ | grep locus_summary | grep chrX | grep -v all | while read l; do cat output/monstr/$l; done > output/monstr/all.chrX.locus_summary.tab
